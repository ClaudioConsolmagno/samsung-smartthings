...
class XiaomiMijiaButtonSpec extends Specification {
    ...
    def "Should convert parse message into IncomingEvent enum type"() {
        ...
        where:
            ...
            'read attr - raw: D0210100060800802002'                             | 'BUTTON_2'
            'read attr - raw: 50B80100060800802002, dni: 50B8, endpo'           | 'BUTTON_2'
            'catchall: 0104 0006 01 01 0100 00 491B 00 00 0000 0A 01 00802003'  | 'BUTTON_3'
            'read attr - raw: D0210100060800802003'                             | 'BUTTON_3'
            'read attr - raw: D0210100060800802003, dni: 50B8, endpoint'        | 'BUTTON_3'
            'catchall: 0104 0006 01 01 0100 00 491B 00 00 0000 0A 01 00802004'  | 'BUTTON_4'
            'read attr - raw: D0210100060800802004'                             | 'BUTTON_4'
            'read attr - raw: D0210100060800802004, dni: 50B8, endpoint'        | 'BUTTON_4'
